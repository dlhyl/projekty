...
@section('modal')
<form id="modal-delete" class="modal fade" method="POST">
    @csrf
    @method('DELETE')
    <div class="modal-dialog modal-confirm">
        <div class="modal-content">
            <div class="modal-header flex-column light-pink-bg delete-modal-header">
                <h4 class="modal-title w-100 dark-red">Are you sure?</h4>
                <button type="button" class="close dark-red" data-dismiss="modal" aria-hidden="true"
                    style="position: absolute;right: 0;margin-right: 0rem;">×</button>
            </div>
            ...
            <div class="modal-footer justify-content-center">
                ...
                <input type="submit" class="btn dark-red-bg text-white" value="Delete"></input>
            </div>
        </div>
    </div>
</form>
                    ...
                    <ul class="card-body sidebar-filter-item-container mb-1">
                        ...
                        <li class="form-check my-2">
                            <input class="form-check-input" type="checkbox" name="{{$filter_name['name']}}"
                                ...
                                {{ (request()->get($filter_name['name']) && in_array($brand,explode(',',request()->get($filter_name['name'])) ?? [])) ? 'checked' : ''}} />
